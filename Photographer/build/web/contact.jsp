<%-- 
    Document   : contact
    Created on : Mar 7, 2020, 12:07:08 AM
    Author     : ANH DUC
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" async="" src="Style/analytics.js"></script>
        <title>Contact - us-123photo.simplesite.com</title>

        <link rel="stylesheet" type="text/css" href="./Style/8596505.design.v26374.css">
        <link rel="canonical" href="http://us-123photo.simplesite.com/420329500">
        <link rel="shortcut icon" href="data:image/x-icon;,">
        <script async="" src="Style/gtm.js"></script>
        <script type="text/javascript" src="Style/FrontendAppLocalePage.aspx"></script>
        <script type="text/javascript" src="Style/frontendApp.min.js"></script>
        <script type="text/javascript" charset="UTF-8" src="Style/common.js"></script>
        <script type="text/javascript" charset="UTF-8" src="Style/map.js"></script>
        <script type="text/javascript" charset="UTF-8" src="Style/util.js"></script>
        <script type="text/javascript" charset="UTF-8" src="Style/marker.js"></script>
        <script type="text/javascript" charset="UTF-8" src="Style/infowindow.js"></script>
        <script type="text/javascript" charset="UTF-8" src="Style/onion.js"></script>
        <script type="text/javascript" charset="UTF-8" src="Style/ViewportInfoService.GetViewportInfo"></script>
        <script type="text/javascript" charset="UTF-8" src="Style/stats.js"></script>
        <script type="text/javascript" charset="UTF-8" src="Style/controls.js"></script>
        <script type="text/javascript" charset="UTF-8" src="Style/vt"></script>
        <script type="text/javascript" charset="UTF-8" src="Style/AuthenticationService.Authenticate"></script>
    </head>
                                                    ...
                                                    <div class="gm-style"
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <img src="Style/StaticMapService.GetMapImage"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div aria-hidden="true"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <img src="Style/vt(1)" draggable="false"
                                                                                 alt=""
                                                            ...
                                                            <a target="_blank"
                                                               ...
                                                               style="position: static; overflow: visible; float: none; display: inline;">
                                                                <div style="width: 66px; height: 26px; cursor: pointer;">
                                                                    <img src="Style/google4.png" draggable="false"
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <img src="Style/mapcnt6.png" draggable="false"
                                                        ...
                                                        <div
                                                            ...
                                                            <img src="Style/sv5.png" draggable="false"
                                                        ...
                                                        <div class="gmnoprint gm-bundled-control gm-bundled-control-on-bottom"
                                                            ...
                                                            <div class="gm-svpc" controlwidth="28" controlheight="28"
                                                                ...
                                                                <div style="position: absolute; left: 1px; top: 1px;">
                                                                    <div aria-label="Street View Pegman Control"
                                                                        ...
                                                                        <img src="Style/cb_scout5.png" draggable="false"
                                                            ...
                                                            <div class="gmnoprint" controlwidth="28" controlheight="0"
                                                                ...
                                                                <div title="Rotate map 90 degrees"
                                                                    ...
                                                                    <img src="Style/tmapctrl4.png" draggable="false"
